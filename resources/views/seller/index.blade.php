                                          ...
                                          <form method="post" action="{{ route('submit_bid') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group mb-3">
                                              <div class="row">
                                                ...
                                                <div class="col">
                                                  <input type="number" placeholder="0%-100%" class="form-control" name="optional_take_or_pay_to_seller" min="0" max="100" required/>
                                                </div>
                                                <div class="col-xl-1"></div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                              <div class="row">
                                                ...
                                                <div class="col">
                                                  <input type="number" placeholder="0%-100%" class="form-control" name="optional_delivery_or_pay_to_seller" min="0" max="100" required/>
                                                </div>
                                                <div class="col-xl-1"></div>
                                              </div>
                                            </div>
